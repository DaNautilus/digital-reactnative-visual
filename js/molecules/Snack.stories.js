    ...
    return (
      <View style={{ position: 'absolute', left: 0, right: 0, top: 0 }}>
        <Snack
          ...
          error
          message="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas eget ornare elit."
        />
        <View style={{ position: 'absolute', left: 0, right: 0, top: 100 }}>
          <Button onPress={() => this.snack.show()} primary block>
            Open
          </Button>
          <Button onPress={() => this.snack.hide()} primary block>
            Close
          </Button>
        </View>
      </View>
...
storiesOf('Snack', module).add('Sample', () => (
  <View style={{ flex: 1 }}>
    <Page>
