...
export default function ListItem({ children, title, text, multiline, figure, icon, rightFigure, rightIcon, onPress, style, ...props }) {
  ...
  if (!finalRightFigure && rightIcon) finalRightFigure = <Icon name={rightIcon} style={{ marginLeft: 10 }} />;


  let borderColor = getColor(props, colors.white);
