...
export default class AnimatedLogin extends Component {
  ...
  reset() {
    const { animateValue, animateValue2, animateValue3 } = this.state;
  ...
  render() {
    ...
    return (
      <View
        style={[{ flex: 1, flexDirection: 'row', backgroundColor: shabbyWhite }, containerStyle]}
      >
        <View
          style={{
            transform: [
        ...
        <View style={{ flex: 1, alignSelf: 'center' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
            <Animated.View
              style={[
                ...
                {
                  transform: [{ translateY: this.interp('animateValue', [0, height / 2 + 200]) }],
                },
              ]}
            >
              {children}
          ...
          <Animated.View
            style={[
              ...
              {
                transform: [{ translateY: this.interp('animateValue', [0, (height / 2) * -1]) }],
              },
            ]}
          >
            {logo}
        ...
        <Animated.View
          style={[
            ...
            {
              transform: [{ translateY: this.interp('animateValue', [0, 100]) }],
            },
          ]}
        >
          {footer}
